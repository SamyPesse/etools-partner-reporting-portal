...
from .views import (
    ...
    ClusterObjectiveSimpleListAPIView
)
...
urlpatterns = [
    ...
    url(r'^(?P<response_plan_id>\d+)/cluster-objectives-ref-simple-list/$',
        ClusterObjectiveSimpleListAPIView.as_view(),
        name="cluster-objectives-ref-simple-list"),
]
